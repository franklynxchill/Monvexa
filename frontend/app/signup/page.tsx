  ...
  if (successMessage) {
    return (
      <div className="fixed inset-0 z-50 flex justify-center pt-10 px-4 pointer-events-none">
        <div className="w-full max-w-md backdrop-blur-xl bg-white/80 border border-white/30 shadow-2xl rounded-3xl p-6 pointer-events-auto animate-in slide-in-from-top duration-300">
      ...
      <div className="flex items-center justify-center min-h-screen py-10">
        <div className="w-full max-w-lg">
          ...
          <form
            ...
            className="rounded-xl bg-white mt-7 px-4 py-8 md:p-8 shadow-sm"
          >
